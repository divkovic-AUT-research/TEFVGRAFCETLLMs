...
try:
    response = client.messages.create(
        model="claude-3-7-sonnet-20250219",  # Claude Sonnet 4 with hybrid reasoning capabilities
        max_tokens=4000,
        temperature=0,
...
with open("exclusions_claude-3-7-sonnet-20250219.csv", "w", newline="", encoding="utf-8") as f:
